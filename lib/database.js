...
module.exports = function(_dbhouse) {
	...
	this.execute = function(callback) {
		...
		self.dbHouse.driver.execute(self.dbName, self.tableName, self.model, function(db, collection) {
	...
	this.query = function(callback) {
		...
		self.dbHouse.driver.query(self.dbName, self.tableName, self.model, self.conditions, options, function(err, data) {
	...
	this.delete = function(callback) {
		self.dbHouse.driver.delete(self.dbName, self.tableName, self.model, self.conditions, function(err, data) {
			if (callback)
				callback.apply(self, [ err, data ]);
		});
	};
	...
	this.insert = function(data, callback) {
		...
		self.dbHouse.driver.insert(self.dbName, self.tableName, self.model, data, { idType: self.idType }, function(err, data) {
			callback.apply(self, [ err, data ]);
		});
	};
	...
	this.update = function() {
		...
		self.dbHouse.driver.update(self.dbName, self.tableName, self.model, data, self.conditions, options, function(err, data) {
			callback.apply(self, [ err, data ]);
		});
	};
	...
	this.replace = function(data, callback) {
		...
		self.dbHouse.driver.replace(self.dbName, self.tableName, self.model, data, self.conditions, options, function(err, data) {
			callback.apply(self, [ err, data ]);
		});
	};
	...
	this.drop = function(callback) {
		self.dbHouse.driver.drop(self.dbName, self.tableName, self.model, function() {
			if (callback)
				callback();
		});
	};
